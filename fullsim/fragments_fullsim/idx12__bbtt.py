...
# ggHH_SMEFT gridpack for this parameter point (HH->bb tau tau).
# Gridpack (13.6 TeV Run-3 production) staged on the worker by run_generic_tarball_cvmfs.sh.
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/a/acarvalh/smeft_gridpacks_5param_keep_stage1/powheg_ggHH_SMEFT_CHbox_m0p190055_CH_m21p0271_CuH_1p34314_CHG_m0p0089885_CtG_0p0211719_gridpack.tar.gz'),
...
# Full parton shower + hadronization; the di-Higgs decay is forced to HH->bb tau tau.
generator = cms.EDFilter("Pythia8HadronizerFilter",
    maxEventsToPrint = cms.untracked.int32(1),
    pythiaPylistVerbosity = cms.untracked.int32(1),
    filterEfficiency = cms.untracked.double(0.5),   # ~fraction of showered events the ResonanceDecayFilter keeps for HH->bb tau tau
