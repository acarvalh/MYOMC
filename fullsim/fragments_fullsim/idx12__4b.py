...
# ggHH_SMEFT gridpack for this parameter point (HH->bb bb).
...
# Full parton shower + hadronization; the di-Higgs decay is forced to HH->bb bb.
generator = cms.EDFilter("Pythia8HadronizerFilter",
    maxEventsToPrint = cms.untracked.int32(1),
    pythiaPylistVerbosity = cms.untracked.int32(1),
    filterEfficiency = cms.untracked.double(1.0),   # ~fraction of showered events the ResonanceDecayFilter keeps for HH->bb bb
